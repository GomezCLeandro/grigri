function validarDatos() {
	...
	if (password.trim() == "") {
		divMensajeError.innerHTML = "<font color='red'> El password no debe estar vacio js</font><br><br>";
		return;
	}
	if (password.length < 3) {
		divMensajeError.innerHTML = "<font color='red'> EL password de usuario debe contener al menos 3 caracteres js</font><br><br>";
		return;
	}
	if (nombre.trim() == "") {
		divMensajeError.innerHTML = "<font color='red'> El nombre de usuario no debe estar vacio js</font><br><br>";
